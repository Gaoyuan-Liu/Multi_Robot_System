...
if("TRUE" STREQUAL "TRUE")
  set(merge_SOURCE_PREFIX /home/liu/Multi_Robot_System/src/merge)
  set(merge_DEVEL_PREFIX /home/liu/Multi_Robot_System/devel_isolated/merge)
  set(merge_INSTALL_PREFIX "")
  set(merge_PREFIX ${merge_DEVEL_PREFIX})
else()
  set(merge_SOURCE_PREFIX "")
  set(merge_DEVEL_PREFIX "")
  set(merge_INSTALL_PREFIX /home/liu/Multi_Robot_System/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/liu/Multi_Robot_System/src/merge/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND merge_EXPORTED_TARGETS ${${merge_dep}_EXPORTED_TARGETS})
endforeach()
