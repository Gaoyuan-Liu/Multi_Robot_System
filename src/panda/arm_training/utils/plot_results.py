...
class LivePlot(object):
    def __init__(self, outdir, data_key='episode_lengths', line_color='blue'):#data_key=episode_lengths/episode_rewards
        """
    ...
    def plot(self, full=False, dots=False, average=0, interpolated=0):
        results = wrappers.monitor.load_results(self.outdir)
