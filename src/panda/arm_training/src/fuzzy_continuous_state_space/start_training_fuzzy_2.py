...
import manipulator_env_fuzzy_2
...
if __name__ == '__main__':
    ...
    env = gym.make('ManipulatorRLControl-v3')
    ...
    qlearn = qlearn_fuzzy.QLearn(actions=range(env.action_space.n),
    ...
    for x in range(nepisodes):
        ...
        for i in range(nsteps):
            ...
            qlearn.learn_fuzzy(actual_state, action, reward, next_actual_state)
