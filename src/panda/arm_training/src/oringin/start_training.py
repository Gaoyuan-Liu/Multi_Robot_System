...
if __name__ == '__main__':
    ...
    env = gym.make('ManipulatorRLControl-v1')
    ...
    with open('/home/liu/drone_training_ws/src/drone_training/training_results/final_Q_table.pkl', 'wb') as f:
        pickle.dump(qlearn.qtable, f, pickle.HIGHEST_PROTOCOL)
